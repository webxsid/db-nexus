...
export const MongoActiveCollectionListPanel: FC = () => {
  const collections = useAtomValue(mongoActiveCollectionListAtom);
  const [selectedDb, setSelectedDb] = useAtom(mongoSelectedDatabaseAtom);
  const [selectedCollection, setSelectedCollection] = useAtom(
    mongoSelectedCollectionAtom,
  );

  const handleSelectCollection = (collection: string, database: string): void => {
